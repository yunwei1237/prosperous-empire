...
## slot
## 职责，同伴在队伍的职责
from ID_troops import trp_player
...
partyManage={
    ...
    "dialogs":[
        ...
        [anyone, "adjutant_appoint_talk", [
            ...
            (ge,":int_level",adviser_least_int_level),
        ...
        [anyone, "adjutant_appoint_talk", [
            ## 智力大于12
            (store_attribute_level, ":int_level", "$g_talk_troop", sf_base_att_int),
            (lt, ":int_level", adviser_least_int_level),
        ],"I'm sorry I can't do the job", "member_talk", []],
        ## 不能接受2，该职位已经有人在做
        [anyone, "adjutant_appoint_talk", [
            ## 职位空缺
            (gt, "$g_player_adjutant", 0),
        ...
        [anyone, "adjutant_appoint_talk", [
            ...
            (party_get_slot,":duty","$g_talk_troop",slot_party_team_duty),
            (gt,":duty",sptd_none),
        ], "I already have a very important job", "member_talk", []],
        ## 副官职责
        ###### 进入副官对话
        [anyone | plyr, "member_talk", [
            (party_slot_eq,"$g_talk_troop",slot_party_team_duty,sptd_adjutant),
        ...
        [anyone | plyr, "adjutant_team_talk", [],"I want to dismiss a adviser", "adjutant_appoint_adviser_into_talk_choice", [
            ## 解雇
        ...
        ## 提示玩家进入选择职位的列表
        [anyone, "adjutant_appoint_military_surgeon_talk", [], "Who do you appoint ?","adjutant_appoint_military_surgeon_talk_choice", []],
        ## 不选择的选项（玩家点击失误时，取消的选项）
        ...
        [anyone | plyr | repeat_for_troops, "adjutant_appoint_military_surgeon_talk_choice", [
            ...
            (try_begin),
                ...
                (gt, reg1, 0),
                (assign,":is_fit",1),
                (str_store_string,s2,"@inventory management:{reg1}"),
            (else_try),
                ## 厨师官
                (eq, reg10, sptd_chef),
                ## 保存队员技能等级
    ...
    "internationals":{
        "cns":{
            ...
            "dialogs":[
                ...
                "dlga_adjutant_appoint_talk:member_talk.1|我 不 能 胜 任 这 个 工 作",
                "dlga_adjutant_appoint_talk:member_talk.2|已 经 有 人 在 做 这 个 工 作 了 ( {s1} )",
                "dlga_adjutant_appoint_talk:member_talk.3|我 已 经 有 一 个 很 重 要 的 工 作 了",
                ...
                "dlga_adjutant_team_talk:adjutant_appoint_adviser_into_talk_choice.1|我 想 任 命 一 个 谋 士",
                ...
                "dlga_adjutant_team_talk:adjutant_appoint_military_surgeon_talk|我 想 要 任 命 一 个 {s1}",


                "dlga_adjutant_appoint_military_surgeon_talk:adjutant_appoint_military_surgeon_talk_choice|你 想 任 命 谁 ?",
            ],
            "quick_strings":[
